...
export class SplashScreen extends com.viksaa.sssplash.lib.activity.AwesomeSplash {
    ...
    initSplash(configSplash) {
        ...
        configSplash.setBackgroundColor(org.nativescript.RPSConferenceApp.R.color.md_blue_900); //any color you want form colors.xml
        ...
        //Customize Logo
         configSplash.setLogoSplash(org.nativescript.RPSConferenceApp.R.drawable.splash_logo); //or any other drawable
        ...
        const title = com.tns.NativeScriptApplication.getInstance().getString(org.nativescript.RPSConferenceApp.R.string.splash_title)
        //Customize Title
        configSplash.setTitleSplash(title);
        configSplash.setTitleTextColor(org.nativescript.RPSConferenceApp.R.color.md_white);
